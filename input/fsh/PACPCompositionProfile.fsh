...
* section[personal_advance_care_plan].section[gpp_personal_care_experience].entry only Reference(PADICareExperiencePreference or PADIPersonalPrioritiesOrganizer or PADIPersonalHealthGoal)  // Missing personal Health Goal
...
* section[personal_advance_care_plan].section[gpp_for_end_of_life_or_severely_dibilitating_condition].entry only Reference(PADIPersonalInterventionPreference or PADIPersonalPrioritiesOrganizer or PADIPMOLSTObservation or $USCoreGoal)  // Missing personal Health Goal
...
* section[personal_advance_care_plan].section[gpp_upon_death].entry only Reference(PADIPersonalInterventionPreference or PADIPersonalPrioritiesOrganizer or PADIAutopsyObservation or PADIOrganDonationObservation or $USCoreGoal)  // Missing personal Health Goal
