...
* section[healthcare_agent_appointment].text 1..1 MS
...
* section[gpp_personal_care_experience].text 1..1 MS
...
* section[gpp_for_end_of_life_or_severely_dibilitating_condition].text 1..1 MS
* section[gpp_for_end_of_life_or_severely_dibilitating_condition].entry MS
* section[gpp_for_end_of_life_or_severely_dibilitating_condition].entry only Reference(PADIPersonalInterventionPreference or PADIPersonalPrioritiesOrganizer or PADIPMOLSTObservation or $USCoreGoal)  // Missing personal Health Goal

* section[gpp_upon_death].title 1..1 MS
* section[gpp_upon_death].code 1..1 MS
* section[gpp_upon_death].code = $LOINC#81337-8
* section[gpp_upon_death].text 1..1 MS
* section[gpp_upon_death].entry MS
* section[gpp_upon_death].entry only Reference(PADIPersonalInterventionPreference or PADIPersonalPrioritiesOrganizer or PADIAutopsyObservation or PADIOrganDonationObservation or $USCoreGoal)  // Missing personal Health Goal
...
* section[administrative_information].text 1..1 MS